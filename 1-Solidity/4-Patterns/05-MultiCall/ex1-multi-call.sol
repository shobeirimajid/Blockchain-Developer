...
contract MultiCall {
    ...
    function multiCall(address[] calldata targets, bytes[] calldata data) external view 
...
/*
    ...
    Multi Call
    ----------------------
    An example of contract that aggregates multiple queries 
    using a for loop and staticcall.
