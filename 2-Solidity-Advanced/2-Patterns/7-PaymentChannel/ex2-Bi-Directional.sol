...
/*
    ...
    --------------------------------
    allow participants Alice and Bob 
    to repeatedly transfer Ether off chain.

    Payments can go both ways:
        Alice pays Bob 
        Bob pays Alice
    ...
    -----------------------
    Closing a channel 
        when Alice and Bob agree on the final balance
    -----------------------
    ...
    -----------------------
    Closing a channel 
        when Alice and Bob do not agree on the final balances
    -----------------------
